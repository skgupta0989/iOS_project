...
#define employeeUpdateUrl @"http://10.132.161.59:8080/EmployeeDetailsManagement/employee/updateEmployee"

@implementation RemoteDataUpdation

- (BOOL)updateRecord :(NSMutableDictionary *)empRecord
{
    
    NSURL *url = [NSURL URLWithString:employeeUpdateUrl];
    ...
    if([result isEqualToString:@"employee updated"])
    {
        return YES;
    }
    else
